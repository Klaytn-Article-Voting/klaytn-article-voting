 ...
 * @title ArticleVoting
 */
contract ArticleVoting is Ownable, InitData {
    ...
    constructor(uint256 startTime_, uint256 endTime_) {
        ...
        TOKEN_VOTING = IERC20(0xe117C1F93c0CfD06ffd7C4615eDF7Cf852109c6f);
    }
    ...
    function initData(uint256 index, Image memory data, address owner) public onlyOwner {
        _initializeData(index, data, owner);
    }
}